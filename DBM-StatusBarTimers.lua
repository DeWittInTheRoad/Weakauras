...
DBT_AllPersistentOptions = {
	["Default"] = {
		["DBM"] = {
			...
			["EndColorAER"] = 1,
			["StartColorIB"] = 1,
			["Font"] = "Interface\\Addons\\SharedMedia_MyMedia\\font\\Naowh.ttf",
			["EndColorAEB"] = 0.247058823529412,
			["HugeTimerX"] = 354.986297607422,
			["BarXOffset"] = 0,
			["EndColorB"] = 0,
